...
<template>
  <div v-if="movie">
    ...
    <button v-if="!isEditingCover && app.user.id === movie.user" @click="isEditingCover = true">
      Edit Cover
    </button>
    <button v-if="app.user.id === movie.user" @click="deleteMovie">DELETE MOVIE</button>
    ...
    <h1>
      ...
      <label v-if="!isEditingName && app.user.id === movie.user" @click="isEditingName = true">✏️</label>
    </h1>
